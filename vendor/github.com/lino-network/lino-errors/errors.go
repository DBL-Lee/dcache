...
// IsClientError determines whether error is client error
func (err *serverError) IsClientError() bool {
	return err.CodeType() < CodeServerInternalError || err.CodeType() == CodeRateLimitExceeded
}
